...
database = {
    createModel:function(){
        db.serialize(function() {
            ...
            db.run('CREATE TABLE point (id INTEGER PRIMARY KEY,name TEXT,coordX TEXT,coordY TEXT,coordZ TEXT,type INTEGER,icon TEXT, CONSTRAINT fk_type_point FOREIGN KEY(type) REFERENCES type(id) ON DELETE SET NULL)');
            ...
            parkingPoint.forEach(element => {                
                ...
                stmt.run(null,"Punto "+i,elementAux[0],elementAux[1],elementAux[2],6,"ic_accessible_park");
                i++;
            });
            ...
            wcPoint.forEach(element => {                
                var elementAux = element.split(',');
                stmt.run(null,"Punto "+i,elementAux[0],elementAux[1],elementAux[2],3,"ic_accessible_wc");
                i++;
            });
            ...
            ascensores.forEach(element => {                
                var elementAux = element.split(',');
                stmt.run(null,"Punto "+i,elementAux[0],elementAux[1],elementAux[2],5,"ic_accessible_elevator");
                i++;
            });
